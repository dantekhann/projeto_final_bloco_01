...
export function main() {
    ...
    produtoController.cadastrar(new Chuteira(produtoController.gerarId(),
        "Total 90", 1, 450.00, "Nike"));

    produtoController.cadastrar(new Bola(produtoController.gerarId(),
        "Jabulani", 2, 600.00, "FIFA"));
            ...
            case 4:
                ...
                if (produto !== null) {
                    ...
                    switch (tipo) {
                        case 1:
                            generico = readlinesync.question("Digite a Marca da Bola: ");
                            produtoController.atualizar(new Bola(id,
                                nome, tipo, preco, generico));
                            break;
                        case 2:
                            fragancia = readlinesync.question("Digite a Marca da Chuteira: ");
                            produtoController.atualizar(new Chuteira(id,
                                nome, tipo, preco, fragancia));
                            break;
                    }
